...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const KHODAMS = [
        ...
        { name: "Naga Basuki", desc: "Naga penjaga keseimbangan alam.", rarity: "LEGENDARY", power: 95, img: "./img/naga_basuki.jpg" },
        // EPIC
        ...
        { name: "Jenglot Berdarah", desc: "Makhluk kecil peminum darah.", rarity: "EPIC", power: 80, img: "./img/jenglot.jpg" },
        { name: "Kuyang", desc: "Kepala terbang pencari bayi.", rarity: "EPIC", power: 84, img: "./img/kuyang.jpg" },
        { name: "Ambatron", desc: "Robot besi dari Ngawi.", rarity: "EPIC", power: 90, img: "./img/ambatron.jpg" },
        { name: "Kucing Oren", desc: "Preman pasar yang ditakuti.", rarity: "EPIC", power: 89, img: "./img/kucing_oren.jpg" },
        { name: "Kecoa Terbang", desc: "Teror sesungguhnya bagi umat manusia.", rarity: "EPIC", power: 99, img: "./img/kecoa.jpg" },
        // RARE
        ...
        { name: "Suster Ngesot", desc: "Menyeret kaki di lorong rumah sakit.", rarity: "RARE", power: 55, img: "./img/suster_ngesot.jpg" },
        { name: "Sapu Lidi", desc: "Senjata emak-emak legendaris.", rarity: "RARE", power: 78, img: "./img/sapu_lidi.jpg" },
        { name: "Mio Mirza", desc: "Motor gaib yang viral.", rarity: "RARE", power: 66, img: "./img/mio_mirza.jpg" },
        { name: "Skibidi Toilet", desc: "Meme yang merasuki otak.", rarity: "RARE", power: 50, img: "./img/skibidi.jpg" },
        { name: "Masbro", desc: "Kapibara santuy.", rarity: "RARE", power: 42, img: "./img/masbro.jpg" },
        // COMMON
        { name: "Pocong", desc: "Suka mengetuk pintu tengah malam.", rarity: "COMMON", power: 40, img: "./img/pocong.jpg" },
        { name: "Tuyul Botak", desc: "Pencuri uang yang lincah.", rarity: "COMMON", power: 30, img: "./img/tuyul.jpg" },
        { name: "Jeruk Purut", desc: "Membawa aura kesedihan.", rarity: "COMMON", power: 35, img: "./img/jeruk_purut.jpg" },
        { name: "Kulkas 2 Pintu", desc: "Dingin tapi penuh makanan.", rarity: "COMMON", power: 10, img: "./img/kulkas.jpg" },
        { name: "Beat Mber", desc: "Suaranya memekakkan telinga warga.", rarity: "COMMON", power: 45, img: "./img/beat_mber.jpg" },
        { name: "Seblak Ceker", desc: "Pedasnya bikin nangis.", rarity: "COMMON", power: 25, img: "./img/seblak.jpg" },
        { name: "Tutup Botol", desc: "Kecil tapi menyakitkan kalau keinjak.", rarity: "COMMON", power: 5, img: "./img/tutup_botol.jpg" },
        { name: "Kasur Kapuk", desc: "Bikin mager seharian.", rarity: "COMMON", power: 15, img: "./img/kasur.jpg" },
        { name: "Vario Getar", desc: "Bergetar sampai ke jiwa.", rarity: "COMMON", power: 40, img: "./img/vario.jpg" },
        { name: "Cicak Dinding", desc: "Diam-diam merayap.", rarity: "COMMON", power: 2, img: "./img/cicak.jpg" },
        { name: "Galon Kosong", desc: "Nyaring bunyinya.", rarity: "COMMON", power: 8, img: "./img/galon.jpg" },
        { name: "Charger Rusak", desc: "Kadang nyambung kadang enggak.", rarity: "COMMON", power: 12, img: "./img/charger.jpg" },
        { name: "Sendal Jepit", desc: "Putus di saat genting.", rarity: "COMMON", power: 3, img: "./img/sendal.jpg" },
        { name: "Ayam Kampus", desc: "Berkokok tiap pagi buta.", rarity: "COMMON", power: 20, img: "./img/ayam.jpg" }
    ];
    ...
    els.input.addEventListener('keypress', (e) => { if (e.key === 'Enter') { e.preventDefault(); startRitual(); } });
    ...
    function revealKhodam(name) {
        ...
        // Easter Eggs
        if (nameLower === "idhoo rz") {
            khodam = { name: "Developer", desc: "Pembuat Cek Khodam.", rarity: "LEGENDARY", power: 100, img: "./img/developer.jpg" };
            hash = 999;
        } else if (nameLower === "ridho") {
            khodam = { name: "Penguasa Kegelapan", desc: "Bayangannya saja bisa membunuh.", rarity: "LEGENDARY", power: 99, img: "./img/penguasa_gelap.jpg" };
            hash = 666;
        } else if (nameLower === "admin") {
            khodam = { name: "System Administrator", desc: "Akses root ke alam gaib.", rarity: "LEGENDARY", power: 100, img: "./img/admin.jpg" };
            hash = 1;
        } else {
            for(let i=0; i<name.length; i++) hash += name.charCodeAt(i);
            khodam = KHODAMS[hash % KHODAMS.length];
        }
        ...
        els.card.img.onerror = function() { this.src = "https://via.placeholder.com/300x400/000000/FFFFFF?text=ENTITY+UNKNOWN"; };
    ...
    async function handleShare() {
        ...
        try {
            const canvas = await html2canvas(card, { backgroundColor: '#050505', useCORS: true, scale: 2, logging: false });
            ...
            canvas.toBlob(async (blob) => {
                ...
                if (navigator.share && navigator.canShare({ files: [file] })) {
                    try {
                        await navigator.share({ title: 'Cek Khodam', text: `Khodam gw: ${els.card.name.innerText}. Cek punya lu!`, files: [file] });
                    } catch (err) { console.log("Share cancelled", err); }
                } else {
                    window.open(`https://wa.me/?text=${encodeURIComponent(`Khodam gw: ${els.card.name.innerText}. Cek khodam lu sekarang!`)}`, '_blank');
                }
    ...
    function handleSave() {
        ...
        setTimeout(() => {
            html2canvas(card, { backgroundColor: '#050505', useCORS: true, scale: 2, allowTaint: true, logging: false })
            .then(canvas => {
    ...
    function saveToFirebase(userName, khodamData) {
        push(ref(db, 'leaderboard'), { user: userName, khodam: khodamData.name, rarity: khodamData.rarity, timestamp: Date.now() });
    }
